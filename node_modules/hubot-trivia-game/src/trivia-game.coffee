...
class ApiClient
  ...
  dev: (resp, command, args...) ->
    ...
    switch command
      when "list-quizzes" then response = @apiGet 'quizzes', listQuizzesCallback
      when "get-quiz" then response = @apiGet "quizzes/#{args[0]}", listQuizzesCallback
...
module.exports = (robot) ->
  ...
  robot.respond /question ([a-z]+) "([\s0-9A-Za-z-]+)"/i, (msg) ->
    command = msg.match[1]
    param = msg.match[2]
